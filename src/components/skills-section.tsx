...
const colorMap = {
  blue: "from-primary-dark to-secondary-gray",
  green: "from-secondary-gray to-primary-dark", 
  emerald: "from-primary-dark to-secondary-gray",
  purple: "from-secondary-gray to-primary-dark",
  orange: "from-primary-dark to-secondary-gray",
  red: "from-secondary-gray to-primary-dark",
  indigo: "from-primary-dark to-secondary-gray"
}

export function SkillsSection() {
  return (
    <section id="skills" className="relative min-h-screen flex items-center overflow-hidden bg-tertiary-light">
      ...
      <div className="container-center section-padding relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="font-semibold text-primary-dark">modern technologies</span>{" "}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {coreSkills.map((skill, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="group relative bg-pure-white/80 backdrop-blur-sm p-6 rounded-2xl border border-tertiary-light/50 hover:border-primary-dark/20 transition-all duration-300 hover:shadow-lg hover:shadow-primary-dark/5"
              >
                <div className="text-center">
                  <h3 className="font-bold text-primary-dark mb-2 group-hover:text-secondary-gray transition-colors duration-300">
                    {skill.name}
                  </h3>
                  <div className="relative w-full bg-tertiary-light rounded-full h-2 mb-2">
                    <motion.div
                      initial={{ width: 0 }}
                      whileInView={{ width: `${skill.level}%` }}
                      transition={{ duration: 1.2, delay: index * 0.1 + 0.5 }}
                      viewport={{ once: true }}
                      className="bg-gradient-to-r from-primary-dark to-secondary-gray h-2 rounded-full"
                    />
                  </div>
                  <span className="text-xs font-medium text-primary-dark">{skill.level}%</span>
                </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {techCategories.map((category, categoryIndex) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="group relative bg-pure-white/80 backdrop-blur-sm p-6 rounded-2xl border border-tertiary-light/50 hover:border-primary-dark/20 transition-all duration-500 hover:shadow-xl hover:shadow-primary-dark/5"
              >
                {/* Category Header */}
                <div className="flex items-center mb-6">
                  ...
                  >
                    <category.icon className="h-5 w-5 text-pure-white" />
                  </motion.div>
                  <h3 className="text-lg font-bold text-primary-dark group-hover:text-secondary-gray transition-colors duration-300">
                    {category.name}
                  </h3>
                </div>
                ...
                <div className="flex flex-wrap gap-2">
                  {category.technologies.map((tech, techIndex) => (
                    <motion.span
                      ...
                      viewport={{ once: true }}
                      className="px-3 py-1.5 bg-tertiary-light/80 hover:bg-primary-dark/10 text-secondary-gray hover:text-primary-dark rounded-lg text-xs font-medium transition-all duration-300 cursor-default"
                    >
                      {tech}
                    </motion.span>
                  ))}
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="absolute bottom-0 left-6 right-6 h-[2px] bg-gradient-to-r from-primary-dark/30 to-transparent rounded-full"
                />
        ...
        >
          ...
          >
            ...
            <span className="font-semibold text-primary-dark">AI/ML integration</span>,{" "}
            <span className="font-semibold text-primary-dark">Web3</span>, and{" "}
            <span className="font-semibold text-primary-dark">Advanced Cloud Architecture</span>.
          </motion.p>
        </motion.div>
      </div>
    </section>
